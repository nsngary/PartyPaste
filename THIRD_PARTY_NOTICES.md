...
PartyPaste bundles the following font software through Fontsource 5.3.0. The
application imports only the listed styles; Vite packages the referenced WOFF2
font binaries with the application.

## Noto Sans TC

- Bundled style: variable weight 100–900, normal
- Source: https://github.com/notofonts/noto-cjk
- Copyright notice: Google Inc.
- License: SIL Open Font License 1.1

## Press Start 2P

- Bundled style: Latin 400, normal
